...
#   file_folder                 = "C:\\Users\\steve\\OneDrive\\Desktop\\Netflix recommendation\\Netflix project\\data"
...
# 
#   save_folder                 = "C:\\Users\\steve\\OneDrive\\Desktop\\Netflix recommendation\\Netflix project\\data"
...
call_recommender <-function(user_idx_2_rec, recom_type, N_mov_2_rec, kNN_vec){
  ...
  # project top folder
  project_folder                = "C:\\Users\\steve\\OneDrive\\Desktop\\Netflix recommendation\\Netflix project"
...
build_list_user <-function(){
  load(file="C:\\Users\\steve\\OneDrive\\Desktop\\Netflix recommendation\\Netflix project\\code\\Rshiny\\training\\user_list.dat")
  ret = list()
    for(i in 1:4){
      ret[[i]] = build_df(new_user_df_list[[i]])
    }
  new_user_df_list = ret
  save(new_user_df_list,file="C:\\Users\\steve\\OneDrive\\Desktop\\Netflix recommendation\\Netflix project\\data\\user_list.dat")
}
...
server <- function(input, output) {
  ...
  load(file="C:\\Users\\steve\\OneDrive\\Desktop\\Netflix recommendation\\Netflix project\\data\\user_list.dat")
